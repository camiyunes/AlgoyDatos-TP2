...
public class Ficha {
	...
	public static final char COLOR_VACIO = '_'; // Color vacío de la ficha
	 ...
	 * @param z, entero que representa la posición en el eje Z.
	 */
	public Ficha(int x, int y, int z) { this(COLOR_DEFAULT, x, y, z); }
    
	public Ficha(char color) { this(color, 0, 0, 0); }
	...
	public void mover(int nuevoX, int nuevoY, int nuevoZ) {
		if (!bloqueada) {
			...
			this.y = nuevoY;
			this.z = nuevoZ;
		} else { System.out.println("La ficha está bloqueada y no se puede mover."); }
	}
	...
	public char getColorVacio() { return COLOR_VACIO; }
